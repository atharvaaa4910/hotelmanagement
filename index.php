...
<!-- Carousel  -->
 ...
 <section class="py-5 white-section" id="introduction" >
   <div class="container">
     <h1 class="display-4 title"><?php echo $general_setting['Name'] ?>,luxury collections ,Kolhapur.</h1>
   ...
   <div class="container"> 
           ...
           <p class="text-justify">This ornate, palatial tribute to Southern India's greatest empires -The pasific - overlooks 
               verdant foliage in the heart of Kolhapur. This luxury hotel offers one of the largest banqueting 
               ...
               <p><blockquote class="blockquote">Ideal Location</blockquote>
                       ...
                       ,Pasific in Kolhapur is within close proximity to many key areas of Kolhapur and is just 8
           ...
           <div class="row">
               ...
               <div class="row">
                   ...
                   <div class="box container text-center">
                       ...
                       <p class="mb-4">Embodying our commitment to holistic wellbeing, Hotel Sayaji offers facilities that provide healthier options for a better stay.</p>
