            ...
            <div class="row">
                <div class="col-md-12 col-lg-6 col-sm-12 mt-4">
                    ...
                    <p class="title-para ml-5">The four-star PACIFIC INTERNATIONAL Hotel is a jewel
                       of the 19th century architecture, located in the strict centre of Kolhapur, at washington Street. 
...
<div class="intro py-5">
                ...
                <p class="text-center">Make the Most Of Your Time in Kolhapur </p>
</div>
<div class="row pb-4">
<div class="col-md-4 col-sm-6">
<ul>
<li>Connect, create and innovate in the flexible meeting venues at our business hotel in Kolhapur</li>
...
<div class="col-md-4 col-sm-6">
<ul>
<li>Host up to 1,200 in the largest, most sophisticated conference venue in downtown Kolhapur</li>
  ...
  <div class="container py-6">
    ...
    <div class="row" style="justify-content: center">
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Gaurav Shinde <br /> <small>Head of Marketing At Hotel Elite</small> </div>
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Atharv Mahadik <br /> <small>CEO of Hotel Elite</small> </div>
                    <div class="card-subtitle">
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    <div class="profile"> <img src="assets/picture/Founder3.jpg"> </div>
                    <div class="card-title"> Balaji Salunkhe<br /> <small>CFO of Hotel Elite</small> </div>
                    <div class="card-subtitle">
                        <p> <small class="text-muted"> As a hotel CFO, I am a strategic leader responsible for managing all financial aspects of the organization. </small> </p>
                    </div>
                </div>
            </div>
        </div>
